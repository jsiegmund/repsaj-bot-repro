...
public class MainDialog : IDialog<BasicForm>
{
    ...
    public virtual async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> argument)
    {
        ...
        context.Call(ExternalDialog.BasicForm.BuildFormDialog(FormOptions.PromptInStart), FormComplete);
    }

    private async Task FormComplete(IDialogContext context, IAwaitable<ExternalDialog.BasicForm> result)
    {
        try
        {
